...
/**
  ...
  /**
   * `prisma.baselines`: Exposes CRUD operations for the **Baselines** model.
    * Example usage:
    * ```ts
    ...
    * ```
    */
  get baselines(): Prisma.BaselinesDelegate<ExtArgs, { omit: OmitOpts }>;
