    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f8fafc] p-6 text-center">
      <div className="max-w-md space-y-4">
        ...
        <p className="text-slate-600">
          Based on your screening answers, you should be cleared by a doctor before
          starting an unsupervised recovery programme. Please consult your physician
          and have them certify that you are in good condition to proceed.
        </p>
        <p className="text-sm text-slate-400">
          If your doctor has already assessed you, ask them to assign you within the
          app so you can continue.
        </p>
      </div>
    </div>
  );
