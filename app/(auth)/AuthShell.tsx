    ...
    <div className="grid min-h-screen place-items-center bg-bg px-5 py-12">
      <div className="w-full max-w-md">
        <div className="mb-6 flex items-center justify-center gap-2.5">
          ...
          <span className="text-[17px] font-semibold text-ink">Recovery</span>
        </div>
        ...
        <div className="rounded-xl border border-border bg-surface p-7 shadow-sm md:p-8">
          ...
          {error && (
            <p role="alert" className="mt-5 rounded-md bg-critical-soft px-3 py-2.5 text-[14px] text-critical-ink">
              {error}
            </p>
          )}
        ...
        <p className="mt-5 text-center text-[14px] text-ink-muted">{footer}</p>
      </div>
    </div>
  );
}
