...
export const ExerciseCategoriesSchema = z
    .object({
        // Strength / Resistance
        resistance: ExerciseMetricsSchema.optional().describe(
            "For weight-bearing or strength moves (e.g., reps, sets, load)",
        ),

        // Mobility / Flexibility
        mobility: ExerciseMetricsSchema.optional().describe(
            "For stretching or ROM (e.g., hold time, repetitions)",
        ),

        // Cardiovascular / Aerobic
        aerobic: ExerciseMetricsSchema.optional().describe(
            "For endurance (e.g., duration, distance, heart rate)",
        ),

        // Neuromuscular / Balance
        stability: ExerciseMetricsSchema.optional().describe(
            "For balance and coordination (e.g., sets, time per side)",
        ),
    })
...
export type ExerciseModuleBlueprint = z.infer<
    typeof ExerciseModuleBlueprintSchema
>;
