...
export const SymptomCategoriesSchema = z.object({
  pain: SymptomMetricSchema.optional()
    .describe("Primary daily pain score (0-10); drives the recovery arc and stagnation flag"),
