...
export function MgcShell({ active, children }: { active?: string; children: ReactNode }) {
  return (
    <div className="min-h-screen bg-bg">
      <header className="sticky top-0 z-20 border-b border-border bg-surface/90 backdrop-blur">
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-3 px-5 py-2.5">
          <a href="/preview/mgc" className="flex shrink-0 items-center gap-2">
            <span className="grid size-7 place-items-center rounded-md bg-accent text-[13px] font-semibold text-ink-inverse">R</span>
            <span className="text-[14px] font-semibold text-ink">Recovery</span>
            <span className="rounded bg-attention-soft px-1.5 py-0.5 text-[11px] text-attention-ink">MGC mockup</span>
          </a>
