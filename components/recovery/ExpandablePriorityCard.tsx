...
export function RecentEntries({
    ...
    entries: { day: string; value: string }[];
}) {
    return (
        <div>
            <div className="mb-1.5 text-[12px] font-medium uppercase tracking-wide text-ink-subtle">
                Recent
            </div>
                ...
                {entries.map((e) => (
                    ...
                    >
                        ...
                        <span className="flex items-center gap-2 text-[14px] text-ink">
                            ...
                            <button
                                type="button"
                                aria-label={`Edit ${e.day}`}
                                className="grid size-8 place-items-center rounded text-ink-subtle hover:bg-surface-sunken hover:text-ink"
                            >
