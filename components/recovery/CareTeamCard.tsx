                ...
                <div className="flex-1 space-y-3">
                    <div>
                        ...
                        <p className="mt-0.5 text-[15px] text-ink-muted">
                            Trust your gut. It&apos;s always okay to call your
                            care team — they would much rather hear from you.
                        </p>
                    </div>
                    ...
                    >
                        <Phone size={18} strokeWidth={1.75} /> Call your care
                        team
                    </a>
                    ...
                    <details className="group">
                        ...
                        <div className="mt-2 rounded-md bg-attention-soft/50 p-4">
                            <p className="text-[15px] text-ink">
                                Call your care team straight away if you notice:
                            </p>
                            ...
                            <p className="mt-3 text-[15px] text-ink">
                                Chest pain or trouble breathing is an emergency
                                — call{" "}
