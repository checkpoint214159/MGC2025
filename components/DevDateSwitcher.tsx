...
export function DevDateSwitcher() {
    ...
    const handleDateChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        console.log("new date is what", newDate);
        document.cookie = `dev-simulated-date=${newDate}; path=/; max-age=86400`;
        router.refresh(); // Tells Next.js to re-run the Layout server-side
    };

    return (
        <div
            className={`fixed bottom-4 right-4 p-4 rounded-lg border shadow-2xl z-50
      ${
          isSimulated
